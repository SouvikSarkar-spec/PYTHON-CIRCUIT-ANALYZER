...
Enter your choice: '''))
        ...
        for i in range(number_of_resistors):
            resistor_value = float(input(f"Enter Resistance {i+1} (R{i+1}) in Ohms: "))
...
Enter your choice: '''))
         ...
         if kcl_choice == 1:
            entering_current = int(input("Enter the number of branches entering the circuit: "))
            leaving_current = int(input("Enter the number of branches leaving the circuit: "))
            ...
            if total_current == 0:
                print("KCL is verified. The sum of currents entering and leaving the node is zero.")
            else:
                print("KCL is not verified. The sum of currents entering and leaving the node is not zero.")

         elif kcl_choice == 2:
               no_Entering_current = int(input("Enter the number of branches entering the circuit: "))
               no_Leaving_current = int(input("Enter the number of branches leaving the circuit: "))
               total_leaving_current = 0
               total_entering_current = 0
               choice = input("Do you want to find the unknown current entering or leaving the node? (enter/leave): ").strip().lower()
               ...
               if choice == "enter":
                    unknown_current = total_leaving_current - total_entering_current
                    print(f"Unknown Current entering the node (Iunknown) = {unknown_current:.2f} Amperes")
               else:
                    unknown_current = total_entering_current - total_leaving_current
                    print(f"Unknown Current leaving the node (Iunknown) = {unknown_current:.2f} Amperes")
         elif kcl_choice == 3:
                 print("Returning to Main Menu...")
                 continue
         else:
        ...
        Enter your choice: '''))
                 ...
                 if kvl_choice == 1:
                    source_voltage = int(input("Enter the number of voltage sources in the loop: "))
                    load_voltage = int(input("Enter the number of loads in the loop: "))
                    ...
                    if total_voltage == 0:
                        print("KVL is verified. The sum of voltages around the loop is zero.")
                    else:
                        print("KVL is not verified. The sum of voltages around the loop is not zero.")
        
                 elif kvl_choice == 2:
                       no_Source_voltage = int(input("Enter the number of voltage sources in the loop: "))
                       no_Load_voltage = int(input("Enter the number of loads in the loop: "))
                       type_of_unknown = input("Is the unknown voltage a source or a load? (source/load): ").strip().lower()
                       ...
                       if type_of_unknown == "source":
                           unknown_voltage = total_load_voltage - total_voltage_source
                           print(f"Unknown Voltage (Vunknown) = {unknown_voltage:.2f} Volts")   
                       elif type_of_unknown == "load":
                           unknown_voltage = total_voltage_source - total_load_voltage
                           print(f"Unknown Voltage (Vunknown) = {unknown_voltage:.2f} Volts")
                 elif kvl_choice == 3:
                                    print("Returning to Main Menu...")
                                    continue
